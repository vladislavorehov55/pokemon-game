...
const App = () => {
    ...
    return (
        <>
            ...
            <Layout id={1} title='Rules' urlBg={image}>
            ...
            <Layout id={2} title={'Layout'} descr={'Second layout'} colorBg='red'>
                <div className='flex'>
                    {
                        pokemons.map(pokemon => <PokemonCard key={pokemon.id} name={pokemon.name} id={pokemon.id}
                                                             type={pokemon.type}
            ...
            <Layout id={3} title='Full rules' urlBg={image}>
